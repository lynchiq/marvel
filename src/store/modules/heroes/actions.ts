...
export const getHeroes = {
  ...
  success: createAction<getHeroSuccessPayloadType, "HEROES_REQUEST_SUCCESS">(
    "HEROES_REQUEST_SUCCESS"
  ),
  error: createAction("HEROES_REQUEST_ERROR"),
};

export const getHeroesByName = {
  request: createAction<string, "HEROES_BY_NAME_REQUEST_START">(
    "HEROES_BY_NAME_REQUEST_START"
  ),
  success: createAction<HeroType[], "HEROES_BY_NAME_REQUEST_SUCCESS">(
    "HEROES_BY_NAME_REQUEST_SUCCESS"
  ),
...
export const setHeroesCurrentPage = createAction<
  number,
